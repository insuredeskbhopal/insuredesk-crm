...
export const HOMEPAGE_CONTENT = {
  hero: {
    ...
    description:
      "Bima Headquarter helps individuals, families, and businesses make informed insurance decisions. From our office in Bhopal, we serve clients across India with motor, health, life, commercial, fire, marine, renewal, and claims assistance services.",
    ...
    cards: [
      {
        icon: "shield",
        title: "Brand & Support",
        desc: "Bima Headquarter is a brand owned and operated by InsureDesk IMF Pvt. Ltd. We help clients understand policy options, documentation, renewals, and claim communication with insurers.",
      },
      {
        icon: "share_location",
        title: "Office & Reach",
