...
export const SITE_KEYWORDS = [
  ...
  "Bima Headquarter Danish Nagar",
  "InsureDesk IMF Private Limited",
  "InsureDesk",
  "insurance consultant",
  "insurance consultant Bhopal",
  "insurance claim assistance",
  "insurance claims assistance Bhopal",
  "insurance advisor India",
  "best insurance advisor Bhopal",
  "business insurance",
  "motor insurance",
  "health insurance",
  "life insurance",
  "warehouse insurance",
  "claim support",
  "claim support Bhopal",
  "IRDAI registered insurance marketing firm",
  "corporate risk advisor India",
  "warehouse fire insurance Bhopal",
  "marine cargo insurance consultant India",
  "cashless health insurance consultant",
  "motor fleet insurance agent Bhopal",
];
