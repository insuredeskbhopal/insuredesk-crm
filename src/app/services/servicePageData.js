...
export const servicesBySlug = {
  "general-insurance": {
    ...
    description:
      "Protect personal assets, homes, shops, property, inventory, and liabilities with correctly structured general insurance guidance across India.",
    ...
    ctaText:
      "Share your existing policy or asset details and our team will help identify coverage gaps before they become claim problems.",
  },
  "health-insurance": {
  ...
  "motor-insurance": {
    ...
    description:
      "Compare and renew car, bike, commercial vehicle, and fleet insurance with guidance on IDV, add-ons, NCB, and claim support.",
    heroImage:
  ...
  "life-insurance": {
    ...
    description:
      "Plan term insurance, family protection, savings-linked covers, and key person protection with clear need analysis and policy comparison.",
    heroImage:
  ...
  "commercial-insurance": {
    ...
    description:
      "Protect business assets, stock, liabilities, factories, offices, and operational exposures with commercial insurance advisory across India.",
    heroImage:
  ...
  "warehouse-insurance": {
    ...
    description:
      "Protect warehouse stock, storage liabilities, fire exposure, burglary risk, and fluctuating inventory values with structured insurance guidance.",
    heroImage:
  ...
  "marine-insurance": {
    ...
    description:
      "Cover goods moving by road, rail, air, or sea with marine cargo and inland transit insurance advisory for businesses across India.",
    heroImage:
  ...
  "policy-renewals": {
    ...
    description:
      "Avoid coverage gaps with timely renewal review, premium comparison, updated risk assessment, and policy continuity support across India.",
    heroImage:
  ...
  "claims-assistance": {
    ...
    description:
      "Get professional help with insurance claim documentation, rejection review, surveyor coordination, and settlement follow-up across India.",
    heroImage:
  ...
  "risk-advisory": {
    ...
    description:
      "Identify insurance gaps, asset valuation issues, operational exposures, and risk-control priorities with corporate advisory support across India.",
