                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="h-13 w-13 sm:h-14 sm:w-14 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100/70 border border-emerald-200/80 flex items-center justify-center text-emerald-800 shadow-2xs group-hover:scale-105 group-hover:border-emerald-300 transition-all shrink-0">
                      <Smartphone className="h-7 w-7 text-emerald-800" strokeWidth={2.2} />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-50 border border-emerald-200/90 text-[10px] font-black uppercase tracking-wide text-emerald-800">
                ...
                <div className="flex items-center justify-between pb-3.5 mb-4 border-b border-slate-100">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-left">
                      <div className="text-xs font-bold text-slate-900">Scan with Phone</div>
        ...
        <section className="mb-16 lg:mb-24">
          <div className="rounded-3xl bg-white p-6 sm:p-10 border border-slate-200/90 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {/* Step 01 */}
              <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-2xs hover:border-slate-300 transition-all space-y-3 text-left">
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-black text-slate-300">01</span>
                  <div className="h-9 w-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-700 shadow-2xs">
              ...
              <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-2xs hover:border-slate-300 transition-all space-y-3 text-left">
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-9 w-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-emerald-600 shadow-2xs">
                    <ShieldCheck className="h-4 w-4" />
                  </div>
                </div>
                <div className="font-bold text-sm text-slate-900">Permit Installation</div>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="mt-6 p-4 rounded-xl bg-emerald-50/50 border border-emerald-200/70 text-left flex items-start gap-3">
