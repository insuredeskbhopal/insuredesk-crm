const SECTION_DEFINITIONS = [
  ...
  ["insured_details", [/Insured/i, /Proposer/i, /Customer Name/i, /Communication Address/i, /Mailing Address/i]],
  ["vehicle_details", [/Vehicle Details/i, /INSURED MOTOR VEHICLE DETAILS/i, /Registration No/i, /Chassis No/i, /Engine No/i]],
  ["premium_details", [/Premium Details/i, /SCHEDULE OF PREMIUM/i, /Total Premium/i, /Net Premium/i, /Gross Premium/i]],
  ...
  SECTION_DEFINITIONS.forEach(([type, patterns]) => {
    ...
    if (firstLine !== -1) {
      matches.push({
        ...
        matchedLabel,
        text: lines.slice(firstLine, Math.min(lines.length, firstLine + 46)).join("\n").trim()
      });
    }
  });
