...
export const DEFAULT_COMPANIES = [
  ...
  { name: "HDFC Ergo", aliases: ["HDFC ERGO General Insurance", "HDFC Ergo General Insurance Company Limited"] },
...
export const DEFAULT_POLICY_TYPES = [
  {
    ...
    name: "Car Insurance",
    aliases: ["Private Car Package Policy", "Motor Package Policy"],
    keywords: ["private car", "vehicle number", "registration no", "chassis no", "engine no", "idv"],
    fields: [
      field("insuredName", "Insured Name", "text", true, ["Name of the Insured", "Insured Name", "Proposer Name"]),
      field("policyNumber", "Policy Number", "text", true, ["Policy No", "Policy Number", "Policy Schedule No", "Certificate No"]),
      field("insurerName", "Insurer Name", "text", true, ["Insurance Company", "Insurer", "Company Name"]),
