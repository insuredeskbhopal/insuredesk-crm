...
function fallbackForField(text, field) {
  ...
  if (key.includes("registrationnumber") || label.includes("registration number") || label.includes("registration no")) return firstMatch(text, FALLBACK_PATTERNS.vehicleNumber);
  if (key.includes("policytype") || label.includes("policy type")) return firstMatch(text, FALLBACK_PATTERNS.policyType);
  if (key.includes("policycovertype") || key.includes("covertype") || label.includes("cover type")) return firstMatch(text, FALLBACK_PATTERNS.policyCoverType);
  if (key.includes("rtolocation") || label.includes("rto") || label.includes("registration authority")) return firstMatch(text, FALLBACK_PATTERNS.rtoLocation);
