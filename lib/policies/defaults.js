...
export const DEFAULT_COMPANIES = [
  { name: "ICICI Lombard", aliases: ["ICICI Lombard General Insurance", "ICICI Lombard General Insurance Company Limited"] },
  { name: "HDFC Ergo", aliases: ["HDFC ERGO", "HDFC ERGO General Insurance", "HDFC ERGO General Insurance Company Limited", "HDFC Ergo General Insurance Company Limited"] },
  { name: "Tata AIG", aliases: ["TATA AIG General Insurance", "Tata AIG General Insurance Company Limited"] },
  { name: "New India Assurance", aliases: ["The New India Assurance", "New India Assurance Company Limited"] }
];
...
export const DEFAULT_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: ["fire", "stock", "building", "machinery", "burglary", "liability", "marine", "msme", "warehouse", "godown", "contents", "fidelity"]
  },
  {
    name: "Bank Insurance",
...
export const DEFAULT_POLICY_TYPES = [
  {
    ...
    name: "Car Insurance",
    aliases: ["Private Car Package Policy", "Private Car Comprehensive Policy", "PRIVATE CAR COMPREHENSIVE POLICY", "Motor Package Policy"],
    keywords: ["private car", "private car comprehensive policy", "vehicle details", "premium details", "vehicle number", "registration no", "chassis no", "engine no", "total idv", "idv", "own damage", "basic third party liability"],
    fields: [
      field("insuredName", "Insured Name", "text", true, ["Name of the Insured", "Insured Name", "Proposer Name"]),
      field("policyNumber", "Policy Number", "text", true, ["Policy No", "Policy No.", "Policy Number", "Policy Schedule No", "Certificate No"]),
      ...
      field("insurerName", "Insurer Name", "text", true, ["Insurance Company", "Insurer", "Company Name", "HDFC ERGO General Insurance Company Limited"]),
      field("vehicleNumber", "Vehicle Number", "text", true, ["Vehicle No", "Vehicle Number", "Registration No", "Regn No"]),
      field("registrationNumber", "Registration Number", "text", false, ["Registration Number", "Registration No", "Reg No"]),
      ...
      field("policyStartDate", "Policy Start Date", "date", true, ["From", "Start Date", "Policy Start Date", "Period From"]),
      field("policyEndDate", "Policy End Date", "date", true, ["To", "Expiry Date", "Policy End Date", "Period To"]),
      ...
      field("premium", "Premium", "currency", true, ["Premium", "Total Premium", "Net Premium", "Premium inclusive Tax"]),
      ...
      field("hypothecationBank", "Hypothecation Bank", "text", false, ["Hypothecation", "Financier", "Bank Clause"])
    ]
  },
  {
    category: "Vehicle Insurance",
  ...
  },
  {
    ...
    keywords: ["msme suraksha kavach", "package policy", "advance", "contents", "burglary", "fidelity", "standard fire", "special perils", "warehouse", "godown"],
...
function healthFields() {
  return [
    ...
    field("premium", "Premium", "currency", true, ["Premium", "Total Premium"]),
    field("membersCovered", "Members Covered", "textarea", false, ["Members Covered", "Insured Persons", "Covered Members"]),
...
function commercialFields(policyName) {
  return [
    field("insuredName", "Insured Name", "text", true, ["Name of the Insured", "Insured Name"]),
    field("policyNumber", "Policy Number", "text", true, ["Policy No", "Policy Number", "Policy Schedule No"]),
    field("insurerName", "Insurer Name", "text", true, ["Insurance Company", "Insurer"]),
    field("policyType", "Policy Type", "text", true, ["Policy Type", policyName]),
    field("riskLocation", "Risk Location", "textarea", true, ["Risk Location", "Premises to be Insured", "Location of Risk"]),
    ...
    field("occupancy", "Occupancy", "textarea", false, ["Occupancy", "Business of the Insured", "Description of Block"]),
    ...
    field("policyEndDate", "Policy End Date", "date", true, ["To", "Expiry Date"]),
    field("hypothecationBank", "Hypothecation Bank", "text", false, ["Hypothecation", "Bank Clause", "Financier"])
  ];
}
...
function msmeSurakshaFields() {
  return [
    ...
    field("mailingAddress", "Mailing Address", "textarea", false, ["Mailing Address of the Insured", "Mailing Address"]),
    ...
    field("businessOfInsured", "Business of Insured", "textarea", false, ["Business of the Insured", "Business"]),
    field("riskLocation", "Premises / Risk Location", "textarea", true, ["Premises to be Insured", "Risk Location", "Location of Risk"]),
    field("issuedAt", "Issued At", "text", false, ["Issued at"]),
    field("premium", "Premium Including GST", "currency", true, ["Premium (`) (Including GST)", "Premium", "Total Premium"]),
    field("hypothecationDetails", "Hypothecation Details", "text", false, ["Hypothecation Details", "Hypothecation", "Bank Clause"]),
    field("loanAccountNumber", "Loan Account Number", "text", false, ["Loan Account No", "Loan Account Number"]),
    ...
    field("brokerMobile", "Broker Mobile Number", "text", false, ["Agency/Broker Mobile No", "Broker Mobile"]),
    field("brokerEmail", "Broker Email", "text", false, ["Agency/Broker Email-ID", "Broker Email"]),
    field("contentsSumInsured", "Contents Sum Insured", "currency", false, ["MSME Suraksha Kavach - Contents", "Contents"]),
    ...
    field("clauses", "Clauses / Endorsements", "textarea", false, ["Subject to Clause", "Endorsement", "Agreed Bank Clause"]),
...
function bankFields(policyName) {
  return [
    field("insuredName", "Insured Name", "text", true, ["Name of the Insured", "Borrower Name", "Insured Name"]),
    field("policyNumber", "Policy Number", "text", true, ["Policy No", "Policy Number", "Certificate No"]),
    field("policyType", "Policy Type", "text", true, ["Policy Type", policyName]),
    field("bankName", "Bank Name", "text", true, ["Bank", "Bank Name", "Financier", "Hypothecation"]),
    field("loanAccountNumber", "Loan Account Number", "text", false, ["Loan Account", "Loan Account No", "LAN"]),
    field("propertyAddress", "Property Address", "textarea", false, ["Property Address", "Risk Location", "Mortgage Property"]),
