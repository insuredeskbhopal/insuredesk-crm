...
export function normalizeRecord(record) {
  ...
  return {
    ...
    renewalRemarks: Array.isArray(payload.renewalRemarks) ? payload.renewalRemarks : Array.isArray(legacy.renewalRemarks) ? legacy.renewalRemarks : [],
    renewalFollowUp: payload.renewalFollowUp || legacy.renewalFollowUp || null,
