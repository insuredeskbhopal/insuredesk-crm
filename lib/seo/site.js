...
export const SITE_TITLE =
  "BIMAHEADQUARTER | Insurance & Claim Consulting";
...
export const MARKETING_PAGES = [
  ...
  },
  {
    ...
    summary:
      "Reach BIMAHEADQUARTER for insurance advice, claim support, and policy consultation.",
    sections: [
  ...
  },
  {
    ...
    summary:
      "Get help choosing motor insurance coverage for personal and commercial vehicles.",
    sections: [
  ...
  },
  {
    ...
    summary:
      "Choose health insurance with suitable sum insured, network hospital access, and claim support.",
    sections: [
  ...
  },
  {
    ...
    summary:
      "Cover property and business assets against fire and allied risks with expert policy review.",
    sections: [
  ...
  },
  {
    ...
    description:
      "Explore insurance services in Bhopal by BimaHeadquarter. We offer general, health, motor, life, commercial insurance, claims assistance, and risk advisory.",
    heading: "Our Insurance Services",
    summary:
      "Complete insurance solutions and expert claim consulting under one roof in Bhopal, Madhya Pradesh.",
    priority: 0.9,
  ...
  },
  {
    ...
    description:
      "Secure your personal and business assets in Bhopal with General Insurance consulting by BimaHeadquarter (Insuredesk IMF Private Ltd).",
  ...
  },
  {
    ...
    description:
      "Get the best health insurance plans for individuals, families, and corporates in Bhopal with BimaHeadquarter's expert consulting.",
    heading: "Health Insurance Consulting",
    priority: 0.8,
    changeFrequency: "monthly"
  },
  {
    ...
    description:
      "Compare and renew car, bike, and commercial vehicle insurance in Bhopal. Get expert claim support at BimaHeadquarter.",
    heading: "Motor Insurance Consulting",
    priority: 0.8,
    changeFrequency: "monthly"
  },
  {
    ...
    description:
      "Plan for your family's financial security. Expert life insurance consulting in Bhopal by BimaHeadquarter (Insuredesk IMF Private Ltd).",
    heading: "Life Insurance Consulting",
    priority: 0.8,
    changeFrequency: "monthly"
  },
  {
    ...
    title: "Commercial & Business Insurance Bhopal | BimaHeadquarter",
    description:
      "Protect your corporate assets, stocks, and liabilities in Bhopal. Professional commercial insurance advisory by BimaHeadquarter.",
  ...
  },
  {
    ...
    title: "Warehouse Insurance Consulting in Bhopal | BimaHeadquarter",
    description:
  ...
  },
  {
    ...
    title: "Marine Insurance Consulting in Bhopal | BimaHeadquarter",
    description:
  ...
  },
  {
    ...
    description:
      "Never let your coverage lapse. Professional assistance for timely policy renewals across all insurance categories in Bhopal.",
  ...
  },
  {
    ...
    description:
      "Facing issues with claim settlements? Get expert representation, documentation support, and claims advocacy in Bhopal.",
  ...
  },
  {
    ...
    description:
      "Identify, assess, and mitigate business risks. Corporate risk advisory services in Bhopal by Insuredesk IMF Private Ltd.",
...
export const BUSINESS_DETAILS = {
  ...
  address: {
    streetAddress: "S-2, 2nd Floor, Nikhil Homes, Danish Nagar Square Main, 2 Narmadapuram Road, Near D-Mart, Opposite Rajasthan Mishtan, Landmark 1",
  ...
  serviceArea: "Bhopal, Madhya Pradesh, India",
