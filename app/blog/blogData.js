export const BLOG_POSTS = [
  {
    ...
    excerpt: "Learn how to document accident damage, coordinate with surveyors, and get your vehicle claim settled quickly without hassle.",
    category: "Claims",
    readTime: "7 min read",
    date: "June 15, 2026",
    ...
    sections: [
      ...
      { type: "paragraph", text: "Intimate your insurance company or consulting partner within 24 to 48 hours of the incident. Delay in claim registration is one of the most common reasons insurers use to reject claims under the 'delayed notification' clause. When registering, specify if you need cashless service or if you will be filing for reimbursement. If the vehicle is not drivable, arrange for a flatbed tow truck to transport it directly to an authorized cashless network garage." },
      { type: "heading", text: "3. Crucial Rules for Surveyor Inspections" },
      { type: "paragraph", text: "Do not authorize the workshop to begin repairs before the surveyor conducts the official inspection. The surveyor needs to verify that the damage matches the description in the claim form. Any pre-authorized repairs will be excluded from the payout. Keep your driving license, vehicle registration certificate (RC), and insurance policy copy handy for physical verification by the surveyor." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Lapsing policies leave you financially vulnerable. Follow this detailed checklist to renew motor, health, and fire policies cleanly.",
    category: "Renewals",
    readTime: "6 min read",
    date: "June 10, 2026",
  ...
  },
  {
    ...
    excerpt: "Understand how cashless claims work at network hospitals, the pre-authorization process, and how to avoid out-of-pocket expenses.",
    category: "Claims",
    readTime: "7 min read",
    date: "June 01, 2026",
    ...
    sections: [
      ...
      { type: "paragraph", text: "A cashless approval does not mean a 100% free stay. Insurers do not pay for non-medical expenses or 'consumables' (like PPE kits, gloves, nebulizer masks, and administrative charges) unless you have a specific rider. Additionally, if your policy has a co-payment clause or a room rent cap, you will have to pay the proportionate difference at the time of discharge." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Zero dep covers the cost of parts like plastic, rubber, and glass during accident repairs. Learn how it saves you money on claims.",
    ...
    sections: [
      ...
      { type: "paragraph", text: "Zero Depreciation covers are typically offered for vehicles up to 5 years old. Some premium insurers extend this to 7 or 10 years for high-end luxury vehicles. Additionally, look out for the number of claims allowed under this add-on per year; while some policies offer unlimited zero-dep claims, others restrict it to two claims per policy term." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Understand how pre-existing conditions like hypertension or diabetes affect health cover and the rules regarding waiting periods.",
    category: "Personal Insurance",
    readTime: "7 min read",
    date: "May 20, 2026",
    author: { name: "Payal Sahu", role: "Non-Motor Insurance Advisory" },
  ...
  },
  {
    ...
    excerpt: "CGL protects businesses against third-party bodily injury, property damage, and slip-and-fall incidents inside retail stores and warehouses.",
    category: "Business Risk",
    readTime: "8 min read",
    date: "May 15, 2026",
  ...
  },
  {
    ...
    excerpt: "Learn how the NCB Protection add-on keeps your motor insurance premium low even if you make a claim during the policy term.",
    category: "Renewals",
    readTime: "6 min read",
    date: "May 10, 2026",
  ...
  },
  {
    ...
    excerpt: "Compare corporate group health covers with individual health policies, focusing on continuity, coverage limits, and custom terms.",
    category: "Personal Insurance",
    readTime: "7 min read",
    date: "May 05, 2026",
    author: { name: "Payal Sahu", role: "Non-Motor Insurance Advisory" },
  ...
  },
  {
    ...
    excerpt: "Mitigate logistics risks. Learn how marine insurance covers annual transit, import-export cargo, and road transport damages.",
    category: "Business Risk",
    readTime: "8 min read",
    date: "May 01, 2026",
  ...
  },
  {
    ...
    excerpt: "Understand out-of-pocket costs. Learn the difference between co-payments, deductibles, and sub-limits in health policies.",
    category: "Personal Insurance",
    readTime: "7 min read",
    date: "April 28, 2026",
    author: { name: "Payal Sahu", role: "Non-Motor Insurance Advisory" },
    ...
    sections: [
      ...
      { type: "paragraph", text: "A co-payment is a fixed percentage of the admissible claim amount that the policyholder must pay. For example, under a 20% co-pay clause, if your hospital bill is Rs. 1,00,000, you must pay Rs. 20,000, and the insurer will pay Rs. 80,000. A deductible, however, is a fixed amount you must pay *before* the insurer starts paying. If your policy has a Rs. 15,000 deductible, you pay the first Rs. 15,000 of the bill, and the insurer covers the rest." },
      { type: "heading", text: "2. Sub-limits and Room Rent Caps" },
      { type: "paragraph", text: "A sub-limit restricts the amount payable for specific treatments (like cataract surgery or maternity) or specific bill components. The most critical sub-limit is the 'Room Rent Cap' (often set at 1% of the sum insured per day). If you choose a room that exceeds this cap, the insurer will apply a proportionate deduction across the entire hospital bill—including doctor fees, surgery costs, and OT charges." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Third-party cover is legally mandatory, but a comprehensive policy protects your own vehicle. Learn which coverage fits your budget.",
    category: "Personal Insurance",
    readTime: "6 min read",
    date: "April 25, 2026",
  ...
  },
  {
    ...
    excerpt: "Commercial fire claims can be rejected due to under-insurance, misrepresentation, or storage of undeclared hazardous materials.",
    category: "Claims",
    readTime: "8 min read",
    date: "April 20, 2026",
  ...
  },
  {
    ...
    excerpt: "Learn how professional risk advisors identify vulnerabilities in commercial premises, reduce hazard exposure, and lower premiums.",
    category: "Business Risk",
    readTime: "7 min read",
    date: "April 15, 2026",
  ...
  },
  {
    ...
    excerpt: "Insured Declared Value (IDV) is the maximum sum assured for your vehicle. Learn how correct IDV calculation protects your claim value.",
    category: "Renewals",
    readTime: "6 min read",
    date: "April 10, 2026",
    author: { name: "Payal Sahu", role: "Renewal & Retention Specialist" },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "paragraph", text: "The grace period is a mandatory window (usually 30 days for health insurance in India) granted by insurers to pay renewal premiums after the official expiry date. While your policy is in a lapsed state during this window, paying the premium before the grace period ends will restore your policy's continuity benefits, such as waiting period credits for pre-existing diseases and No Claim Bonus points." },
      { type: "heading", text: "2. The Risk of Claims during the Grace Period" },
      { type: "paragraph", text: "It is critical to note that the grace period is *not* a period of active coverage. If you or a family member are hospitalized during these 30 days, the insurer will reject the cashless or reimbursement claim. Coverage is only restored *after* the premium is paid and processed by the insurer. Letting your policy lapse—even for a few days—leaves you financially exposed." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Most health plans exclude immediate maternity costs. Understand the standard 2 to 4-year waiting periods and sum insured sub-limits.",
    category: "Personal Insurance",
    readTime: "7 min read",
    date: "April 01, 2026",
    author: { name: "Payal Sahu", role: "Non-Motor Insurance Advisory" },
  ...
  },
  {
    ...
    excerpt: "Flat tires, engine breakdowns, or empty tanks. Learn how RSA covers towing, repair support, and emergency transit.",
    category: "Claims",
    readTime: "6 min read",
    date: "March 25, 2026",
    ...
    sections: [
      ...
      { type: "paragraph", text: "RSA covers a wide range of emergency services. These include towing the vehicle to the nearest authorized workshop, jump-starting a dead battery, changing a flat tire using your spare, delivering emergency fuel (up to 5 liters), and retrieving keys locked inside the car. Some premium RSA add-ons also cover hotel accommodation or taxi support for passengers if the car cannot be repaired on the spot." },
      { type: "heading", text: "2. Impact on No Claim Bonus (NCB)" },
      { type: "paragraph", text: "A key benefit of using Roadside Assistance services is that they do not constitute an official insurance claim. If your car breaks down, you call the RSA helpline for a tow or battery jump-start, your accumulated No Claim Bonus (NCB) discount remains entirely unaffected. It is a service benefit, not an insurance payout, making it highly cost-effective." },
      { type: "list", items: [
  ...
  },
  {
    ...
    excerpt: "Speed up claim settlement. Keep this handy checklist of RC, driving license, invoices, and diagnostic records ready before filing.",
    category: "Claims",
    readTime: "7 min read",
    date: "March 20, 2026",
  ...
  },
  {
    ...
    excerpt: "Burglary claims require proof of forceful entry. Learn how to document theft losses and file claims successfully.",
    category: "Claims",
    readTime: "8 min read",
    date: "March 15, 2026",
  ...
  },
  {
    ...
    excerpt: "Understand what standard health policies exclude, from cosmetics to diagnostic charges, to avoid surprise bills.",
    category: "Personal Insurance",
    readTime: "7 min read",
    date: "March 10, 2026",
    author: { name: "Payal Sahu", role: "Non-Motor Insurance Advisory" },
  ...
  },
  {
    ...
    excerpt: "Learn how the Institute Cargo Clauses (A, B, and C) define the boundaries of cargo and transit risk coverage.",
    category: "Business Risk",
    readTime: "8 min read",
    date: "March 05, 2026",
    author: { name: "Siya Thakur", role: "Transit & Warehouse Risk Consultant" },
  ...
  },
  {
    ...
    excerpt: "Hydrostatic lock and oil leaks can destroy your engine. Learn why the Engine Protection add-on is vital during monsoons.",
    category: "Personal Insurance",
    readTime: "6 min read",
    date: "March 01, 2026",
    author: { name: "Prakhar Patil", role: "Motor Insurance Specialist" },
  ...
  },
  {
    ...
    excerpt: "A fire destroys your property, but the loss of business continues. Learn how Consequential Loss insurance covers lost profits.",
    category: "Business Risk",
    readTime: "8 min read",
