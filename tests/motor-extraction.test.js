...
describe("generic motor policy extraction", () => {
  ...
  it.skip("locks the ICICI Lombard stand-alone two wheeler details for Nikky Gupta", async () => {
    ...
    expect(result).toMatchObject({
      documentFormat: "ICICI_LOMBARD_MOTOR_V1",
      insuredName: "NIKKY GUPTA",
      policyNumber: "3005/O/444714098/00/000",
      policyType: "Stand-Alone Own Damage Two wheeler Insurance Policy",
      insuranceCompany: "ICICI Lombard General Insurance Company Limited",
      contactNumber: "8818889660",
      customerMobile: "8818889660",
      customerEmail: "INSUREDESKBHOPAL@GMAIL.COM",
      vehicleNumber: "KA01JX3865",
      registrationNumber: "KA01JX3865",
      makeModel: "TVS SCOOTY ZEST",
      vehicleMake: "TVS",
      vehicleModel: "SCOOTY ZEST",
      bodyType: "Solo With Pillion",
      manufacturingYear: "2023",
      registrationDate: "26/06/2023",
      engineNumber: "FG5FP2500841",
      chassisNumber: "MD626DG52P2F00851",
      fuelType: "Petrol",
      cubicCapacity: "109",
      seatingCapacity: "2",
      idv: "51,992.00",
      sumInsured: "51,992.00",
      totalIdv: "51,992.00",
      premium: "858.00",
      totalPremium: "858.00",
      netPremium: "727.00",
      odPremium: "727.00",
      tpDriverOwner: "",
      startDate: "19/06/2026 00:00",
      expiryDate: "18/06/2027",
      duration: "12 months",
      policyCoverType: "Own Damage Only",
      rtoLocation: "21ST MAIN ROAD, AGARA, HSR LAYOUT 1ST SECTOR, BENGALURU (KA), 560102",
      rto: "21ST MAIN ROAD, AGARA, HSR LAYOUT 1ST SECTOR, BENGALURU (KA), 560102",
      ncb: "35%",
      ncbPercentage: "35%",
      basicOwnDamage: "519.00",
      roadSideAssistance: "",
      basicThirdPartyLiability: "",
      legalLiabilityToPaidDriver: "",
      paCoverForOwnerDriver: "",
      unnamedPaCover: "",
      netOwnDamagePremium: "727.00",
      netLiabilityPremium: "",
      totalPackagePremium: "727.00",
      cgst: "",
      sgst: "",
      gstAmount: "131.00",
      previousPolicyNumber: "2301207468244300000",
      previousPolicyValidity: "19-06-2025 to 18-06-2026",
      previousInsurer: "HDFCL",
      previousYearNcb: "25%",
      issuanceDate: "18/06/2026",
      invoiceNumber: "",
      covernoteNumber: "",
      premiumCollectionNumber: "1268549839",
      receiptDate: "18/06/2026",
      cscName: "INSUREDESK",
      cscCode: "IMF240706",
      cscContactNumber: "8818889660",
      servicingBranchName: "Bhopal",
